    ...
    <div className="p-8">
      <div className="flex items-end justify-between">
        <div>
          ...
          <h1 className="text-2xl font-bold text-gray-900 mt-1">Tất cả project</h1>
        </div>
        <div className="flex items-center gap-2">
          ...
          >
            ...
            {searchQuery && <span className="w-1.5 h-1.5 rounded-full bg-primary-600" />}
          </button>
      ...
      <div className="flex items-baseline justify-between mt-8 mb-4">
        <h2 className="text-base font-semibold text-gray-900">
          {filteredProjects.length} project{searchQuery && ` (lọc từ ${projects.length})`}
        </h2>
